...
``` r
Collectible_agg <- data.frame(read_csv("./Data/Collectibles/220711_collectibles.csv"))
```
...
``` r
BAYC <- data.frame(read_csv("./Data/Collectibles/220711_bayc.csv"))
```
...
``` r
CP <- data.frame(read_csv("./Data/Collectibles/220711_cryptopunks.csv"))
```
...
``` r
MB <- data.frame(read_csv("./Data/Collectibles/220711_meebits.csv"))
```
