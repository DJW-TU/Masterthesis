...
```{r}
Utility_agg <- data.frame(read_csv("C:/Users/dominik/OneDrive/Uni/Masterthesis/Data/Inputs/Bubble_Tests/Utility/220711_utility.csv"))
ethname <- data.frame(read_csv("C:/Users/dominik/OneDrive/Uni/Masterthesis/Data/Inputs/Bubble_Tests/Utility/220808_ethnameservice.csv"))
Flooz <- data.frame(read_csv("C:/Users/dominik/OneDrive/Uni/Masterthesis/Data/Inputs/Bubble_Tests/Utility/220816_Flooz.csv"))
```
```{r}
