...
```{r}
Art_agg <- data.frame(read_csv("C:/Users/dominik/OneDrive/Uni/Masterthesis/Data/Inputs/Bubble_Tests/Art/220711_art.csv"))
artblocks <- data.frame(read_csv("C:/Users/dominik/OneDrive/Uni/Masterthesis/Data/Inputs/Bubble_Tests/Art/220711_artblocks.csv"))
punkscomic <- data.frame(read_csv("C:/Users/dominik/OneDrive/Uni/Masterthesis/Data/Inputs/Bubble_Tests/Art/220711_punkscomic.csv"))
superare <- data.frame(read_csv("C:/Users/dominik/OneDrive/Uni/Masterthesis/Data/Inputs/Bubble_Tests/Art/220711_superare.csv"))
```
```{r}
