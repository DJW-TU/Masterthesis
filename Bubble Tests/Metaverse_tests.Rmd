...
```{r}
Metaverse_agg <- data.frame(read_csv("C:/Users/dominik/OneDrive/Uni/Masterthesis/Data/Inputs/Bubble_Tests/Metaverse/220711_Metaverse.csv"))
Otherside <- data.frame(read_csv("C:/Users/dominik/OneDrive/Uni/Masterthesis/Data/Inputs/Bubble_Tests/Metaverse/220808_otherside.csv"))
Sandbox <- data.frame(read_csv("C:/Users/dominik/OneDrive/Uni/Masterthesis/Data/Inputs/Bubble_Tests/Metaverse/220808_sandbox.csv"))
neotokyo <- data.frame(read_csv("C:/Users/dominik/OneDrive/Uni/Masterthesis/Data/Inputs/Bubble_Tests/Metaverse/220808_neotokyo.csv"))
```
```{r}
