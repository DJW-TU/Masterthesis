...
```{r}
CRX100 <- data.frame(read_csv("C:/Users/dominik/OneDrive/Uni/Masterthesis/Data/Inputs/Bubble_Tests/Crypto/CRX100.csv"))
#Bitcoin <- data.frame(read_csv("C:/Users/dominik/OneDrive/Uni/Masterthesis/Data/Inputs/Bubble_Tests/Crypto/Bitcoin.csv"))
Bitcoin2 <- data.frame(read_csv("C:/Users/dominik/OneDrive/Uni/Masterthesis/Data/Inputs/Bubble_Tests/Crypto/Bitcoin2.csv"))
Ethereum <- data.frame(read_csv("C:/Users/dominik/OneDrive/Uni/Masterthesis/Data/Inputs/Bubble_Tests/Crypto/Ethereum.csv"))
```

```{r}
#drop columns CRX
#date_column <- seq(from = as.Date("2019-08-03"), to = as.Date("2022-08-02"), by = 'day')
#date_column <- date_column[order(date_column,decreasing=TRUE)]
#CRX100$Date <- date_column
#CRX100 <- CRX100[order(CRX100$Date),]
#CRX100 <- subset(CRX100, select = c(Date,Close))
```

```{r}
date_column <- seq(from = as.Date("2018-01-01"), to = as.Date("2022-08-17"), by = 'day')
date_column <- date_column[order(date_column,decreasing=TRUE)]
Bitcoin2$Date <- date_column
Bitcoin2 <- Bitcoin2[order(Bitcoin2$Date),]
Bitcoin2 <- subset(Bitcoin2, select = c(Date,Open))
```
...
```{r}
colnames(CRX100)[1] <- "DateTime"
colnames(Bitcoin2)[1] <- "DateTime"
colnames(CRX100)[2] <- "avg_usd"
colnames(Bitcoin2)[2] <- "avg_usd"
