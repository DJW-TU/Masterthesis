...
```{r}
Art_data <- data.frame(read_csv("C:/Users/dominik/Desktop/Uni/Masterthesis/Data/Inputs/Bubble_Tests/Art/220711_art.csv"))

#Collectibles
Collectibles_data <- data.frame(read_csv("C:/Users/dominik/Desktop/Uni/Masterthesis/Data/Inputs/Bubble_Tests/Collectibles/220711_collectibles.csv")) 

#Game
Gaming_data <- data.frame(read_csv("C:/Users/dominik/Desktop/Uni/Masterthesis/Data/Inputs/Bubble_Tests/Gaming/220711_game.csv"))

#Metaverse
Metaverse_data <- data.frame(read_csv("C:/Users/dominik/Desktop/Uni/Masterthesis/Data/Inputs/Bubble_Tests/Metaverse/220711_Metaverse.csv"))

#Utility
Utility_data <- data.frame(read_csv("C:/Users/dominik/Desktop/Uni/Masterthesis/Data/Inputs/Bubble_Tests/Utility/220711_utility.csv"))
```
```{r}
...
print(paste(names[x],sum(data[[x]]$Number.of.sales)))
}
```
